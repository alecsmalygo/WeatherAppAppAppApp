    ...
    private func getHourlyView(hour: String, image: Image, temp: String) -> some View {
        VStack(spacing: 20) {
            ...
            Text(temp)
                ...
                .padding()
                .background(RoundedRectangle(cornerRadius: 5).fill(LinearGradient(gradient: Gradient(colors: [ Color("ColorTwo"), Color("ColorSix"), Color("ColorFive"), Color("ColorThree")]), startPoint: .topLeading, endPoint: .bottomTrailing)))
